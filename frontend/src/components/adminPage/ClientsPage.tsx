        ...
        <div className="flex gap-2">
          <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
            ...
            <DialogContent className="max-h-[90vh] overflow-auto w-full">
              <DialogHeader>
                <DialogTitle>{formMode === 'create' ? 'Cadastrar Cliente' : (viewOnly ? 'Detalhes do Cliente' : 'Editar Cliente')}</DialogTitle>
              </DialogHeader>
              <CustomerForm
                formData={formData}
                ...
                formMode={formMode}
                onSubmit={submitForm}
                onClose={() => { setIsFormOpen(false); setFormMode('create'); setViewOnly(false); }}
